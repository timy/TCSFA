...
subroutine sub_ptb_prop( ts, ierr, z_t0, x_t0, vz_t0, vx_t0, w, err_spe, tag )
    ...
    integer:: i
    external:: newton_equation_sub_ptb
...
20  b_last = 0
    ...
    t = t_old
    y = y_old
    call rk4_sub( h, t, y, y_mid, newton_equation_sub_ptb )
    t = t + h
    y = y_mid
    call rk4_sub( h, t, y, y2, newton_equation_sub_ptb )
...
! --------------------------------------------------------------------------------
subroutine newton_equation_sub_ptb( ne, t, y, dy )
    use mod_sub_ptb_prop, only: m_t0,  m_ti
    implicit none
    ...
    return
end subroutine newton_equation_sub_ptb
